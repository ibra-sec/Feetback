...
class Feedback:
    ...
    def __init__(self, master):
        ...
        master.title('Explore Republic of Chad Feedback')
        ...
        ttk.Label(self.frame_header, wraplength = 300,
                  text = ("We're glad you chose Explore Republic of Chad for your recent adventure.  "
                          "Please tell us what you thought about the 'Desert to Lacke Chad' tour.")).grid(row = 1, column = 1)
    ...
    def submit(self):
        ...
        self.clear()
        messagebox.showinfo(title = 'Explore Republic of Chad Feedback', message = 'Comments Submitted!')
