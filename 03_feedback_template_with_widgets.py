...
class Feedback:
    ...
    def __init__(self, master):    
        ...
        ttk.Label(self.frame_header, text = ("We're glad you chose Explore Republic of Chad your recent adventure.  "
                                             "Please tell us what you thought about the 'Desert to lacke' tour."))
